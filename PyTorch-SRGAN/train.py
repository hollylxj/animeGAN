...
#             print(np.shape(high_res_fake.cpu().data))
#             for ind in range(16):
#                 image = high_res_fake.cpu().data[ind]
#                 image.sub_(0.5).div_(0.5) 
#             vutils.save_image(low_res.data[0:16,:,:,:],
#                     '%s/low_res.png' % opt.out, nrow = 4)
               
#                 A = np.array(image).reshape(30,30,3)
#                 print(np.shape(A))
#                 print(A)
